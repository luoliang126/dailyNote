...
<head>
  ...
  <script type="text/javascript">
    // dynamically add base tag as well as cssContent and javascript files.
    // we can't add cssContent/jsContent the usual way, because some browsers (FF) eagerly prefetch resources
    ...
    (function() {
      ...
      addTag('script', {src: '//ajax.googleapis.com/ajax/libs/angularjs/1.2.18/angular.min.js' }, sync);
      addTag('script', {src: '//ajax.googleapis.com/ajax/libs/angularjs/1.2.18/angular-resource.min.js' }, sync);
      addTag('script', {src: '//ajax.googleapis.com/ajax/libs/angularjs/1.2.18/angular-route.min.js' }, sync);
      addTag('script', {src: '//ajax.googleapis.com/ajax/libs/angularjs/1.2.18/angular-cookies.min.js' }, sync);
      addTag('script', {src: '//ajax.googleapis.com/ajax/libs/angularjs/1.2.18/angular-sanitize.min.js' }, sync);
      addTag('script', {src: '//ajax.googleapis.com/ajax/libs/angularjs/1.2.18/angular-touch.min.js' }, sync);
      addTag('script', {src: '//ajax.googleapis.com/ajax/libs/angularjs/1.2.18/angular-animate.min.js' }, sync);
