...
<head>
  ...
  <script type="text/javascript">
    ...
    (function() {
      ...
      addTag('link', {rel: 'stylesheet', href: 'components/bootstrap-3.1.1/css/bootstrap.css', type: 'text/css'});
      ...
      addTag('script', {src: '../angular.js' }, sync);
      addTag('script', {src: '../angular-resource.js' }, sync);
      addTag('script', {src: '../angular-route.js' }, sync);
      addTag('script', {src: '../angular-cookies.js' }, sync);
      addTag('script', {src: '../angular-sanitize.js' }, sync);
      addTag('script', {src: '../angular-touch.js' }, sync);
      addTag('script', {src: '../angular-animate.js' }, sync);
      ...
      addTag('script', {src: 'components/lunr.js-0.4.2/lunr.js' }, sync);
