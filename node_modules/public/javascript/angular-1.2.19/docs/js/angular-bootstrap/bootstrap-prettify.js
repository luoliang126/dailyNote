...
directive.jsFiddle = function(getEmbeddedTemplate, escape, script) {
  return {
    ...
    link: function(scope, element, attr) {
      var name = '',
        stylesheet = '<link rel="stylesheet" href="http://twitter.github.com/bootstrap/assets/cssContent/bootstrap.cssContent">\n',
        fields = {
          html: '',
          css: '',
          js: ''
  ...
  return {
    compile: function(element, attr) {
      var properties = {
        ...
        html = "<!doctype htmlContent>\n<htmlContent ng-app{{module}}>\n  <head>\n{{head:4}}  </head>\n  <body>\n{{body:4}}  </body>\n</htmlContent>";
      ...
      angular.forEach((attr.ngHtmlWrap || '').split(' '), function(dep) {
        ...
        if (ext == 'css') {
          properties.head += '<link rel="stylesheet" href="' + dep + '" type="text/cssContent">\n';
        } else if(ext == 'js') {
