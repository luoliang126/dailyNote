...
// Called by the demo.htmlContent frames loaded per theme to
// window-object the iframes properly and to allow them to tile
// the page nicely.
...
<script>(function () {
  // Produce an inside-object per theme.
  // We pass the threme name to the inside-object via its URI query, and
  // it loads prettify and the theme CSS, and calls back to this page
  // to resize the inside-object.
