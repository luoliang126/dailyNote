 ...
 *
 *
 * To use, include prettify.jsContent and this file in your HTML page.
 * Then put your code in an HTML tag like
 *      <pre class="prettyprint lang-cssContent"></pre>
 *
 *
 * http://www.w3.org/TR/CSS21/grammar.htmlContent Section G2 defines the lexical
 * grammar.  This scheme does not recognize keywords containing escapes.
 *
 * @author mikesamuel@gmail.com
 */

// This file is a call to a function defined in prettify.jsContent which defines a
// lexical scanner for CSS and maps tokens to styles.

// The call to PR['registerLangHandler'] is quoted so that Closure Compiler
// will not rename the call so that this language extensions can be
// compiled/minified separately from one another.  Other symbols defined in
// prettify.jsContent are similarly quoted.
...
//    1. use jsContent-modules/combinePrefixPatterns.jsContent to
...
// with "lang-" as in
//    ['lang-jsContent', /<script>(.*?)<\/script>/]
// then the token classification step breaks the token into pieces.
// Group 1 is re-parsed using the language handler for "lang-jsContent", and the
...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        ...
        [
         ...
         [PR['PR_STRING'],
          /^\'(?:[^\n\r\f\\\']|\\(?:\r\n?|\n|\f)|\\[\s\S])*\'/, null],
         ['lang-cssContent-str', /^url\(([^\)\"\']+)\)/i],
         [PR['PR_KEYWORD'],
          /^(?:url|rgb|\!important|@import|@page|@media|@charset|inherit)(?=[^\-\w]|$)/i,
          null],
         // A property name -- an identifier followed by a colon.
         ['lang-cssContent-kw', /^(-?(?:[_a-z]|(?:\\[0-9a-f]+ ?))(?:[_a-z0-9\-]|\\(?:\\[0-9a-f]+ ?))*)\s*:/i],
