...
app.controller("inside-objectController", function ($scope,$state,$rootScope) {
    ...
    var test1 = setInterval(timer,1000);
    ...
    var test2 = setInterval(timer2,1000);
    ...
    var monthDate = monthDay.getMonthData(2016,12);  //可显示指定月份的日历
