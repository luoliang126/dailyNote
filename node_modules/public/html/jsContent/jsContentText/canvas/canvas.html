    ...
    <ol>
            ...
            <ol>
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            用于填充绘图的渐变对象createLinearGradient / createRadialGradient
                            ...
                            <div>
                                ...
                                <pre>
                                    ...
                                    var grd=ctx.createRadialGradient(75,50,5,90,60,100);  //1.渐变的开始圆的x坐标 2.渐变的开始圆的y坐标 3.开始圆的半径 4.渐变的结束圆的x坐标 5.渐变的结束圆的y坐标 6.结束圆的半径
                ...
                <li>
                    ...
                    <p>
                        strokeStyle和fillStyle使用方法类似(strokeStyle是边框，fillStyle是实心)
                        strokeRect和fillRect使用方法类似
                    </p>
                </li>
                <li>
                    shadowColor:设置或返回用于阴影的颜色。(与shadowBlur配合使用)
                </li>
                <li>
                    shadowBlur:	设置或返回用于阴影的模糊级别。(与shadowColor配合使用)
                </li>
                <li>
                ...
                <li>
                    lineWidth:设置或返回当前的线条宽度。（number类型）
                </li>
                <li>
        ...
        <li>
            ...
            <ol>
                ...
                <li>
                    beginPath()起始一条路径，或重置当前路径。(用于在一个canvas对象中，画多条或多个图)
                </li>
            </ol>
        </li>
    </ol>
