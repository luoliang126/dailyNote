    ...
    <ul>
        ...
        <li>
            ...
            <xmp>
                //main.js中
                import Vue from 'vue';
                var childComponent1 = Vue.extend({   //切记一定要在实例化Vue（new Vue）之前创建组件
                    template:'
                        <div>这是第一个子组件</div>
                    '
                })
                ...
                //定义一个单独的childComponent2.js文件
                import Vue from "vue";
                const childComponent2 = Vue.extend({
                    template:'
                        <div>
                            这是第二个子组件
                        </div>
        ...
        <li>
            ...
            <xmp>
                ...
                7、监听路由切换beforeEach切换前执行，afterEach切换成功后执行（此方法可以监听路由跳转时的函数，例如loadingBar加载条等）
                ...
                9、路由传递参数 ：参考文档：https://segmentfault.com/q/1010000009749320/a-1020000009749399
                <router-link :to="{ name:'game1', params: {num: 123} }">   //其中name:'game1',这个name属性就是定义路由中的name
                <router-link :to="{path:'/hotel',params:{id:item.id}}">
                函数传参：router.push({ name: 'user', params: { userId: 123 }})  //也可以使用path进行
            </xmp>
        </li>
        <li>
        ...
        <li>
            ...
            <ol>
                <li>vue-resource</li>
                <li>原生ajax或者jq的ajax</li>
                <li>
                    axios方法（推荐使用） <a href="http://blog.csdn.net/binginsist/article/details/65630547" target="_blank">参考文档</a>
                    <xmp>
                        ...
                        7、axios虽然好，但是不兼容IE，所以需要引入 npm install es6-promise --save-dev。参考文档：https://segmentfault.com/q/1010000010160881
                           然后再main.js中使用
        ...
        <li>
            ...
            import identity from './modules/identity'   //引入各个子存储文件identity.js
            import event from './modules/event'
            import item5 from './modules/item5'
            import item7 from './modules/item7'
            ...
            4、调用方法时直接this.setGrantResult(response);即可
            </xmp>
        </li>
        ...
        <li>
            ...
            <p><a href="#/jsContent/object">更多拷贝继承方法，参考js面向对象中的继承</a></p>
            <xmp>
                数组中时
                var a = [1,2,3];
                var b = a;
