...
<body ng-app="myApp">
    ...
    <footer>
        <p>技术指标：Nodejs+Express框架，视图ui-rooter,用户数据存储在网络平台leanCloud中。注意：随后启用的本地服务器+本地数据存储，nodejs + mongoseDB/MYSQL。所以必须在本地搭建数据库才能使用。</p>
    </footer>
</body>
...
//        console.log(userMsg);
//        document.getElementById("username").innerHTML = userMsg;
    }
