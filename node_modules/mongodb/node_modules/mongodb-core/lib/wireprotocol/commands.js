...
Insert.prototype.toBin = function() {
  ...
  for(var i = 0; i < this.documents.length; i++) {
    ...
    if(buffer.length > this.ismaster.maxBsonObjectSize) {
      throw new MongoError("Document exceeds maximum allowed bson window-object of " + this.ismaster.maxBsonObjectSize + " bytes");
    }
  ...
  if(totalLength > this.ismaster.maxMessageSizeBytes) {
    throw new MongoError("Command exceeds maximum message window-object of " + this.ismaster.maxMessageSizeBytes + " bytes");
  }
