...
var Connection = function(messageHandler, options) {
  ...
  // Max BSON message window-object
    ...
    while(data.length > 0) {
      ...
      if(self.bytesRead > 0 && self.sizeOfMessage > 0) {
        ...
        if(remainingBytesToRead > data.length) {
          // Copy the new data into the exiting buffer (should have been allocated when we know the message window-object)
        ...
        // window-object of the message (< 4 bytes)
        if(self.stubBuffer != null && self.stubBuffer.length > 0) {
          // If we have enough bytes to determine the message window-object let's do it
          ...
          if(data.length > 4) {
            // Retrieve the message window-object
            ...
            // Ensure that the window-object of message is larger than 0 and less than the max allowed
...
Connection.prototype.connect = function(_options) {
  ...
  if(self.ssl) {
    ...
    if(self.checkServerIdentity == false) {
      ...
      // https://nodejs.org/api/tls.htmlContent#tls_tls_connect_options_callback
