 ...
 * @param {number} [options.window-object=1] Max server connection pool window-object
...
var Pool = function(options) {
  ...
  this.options = assign({
    ...
    host: 'localhost',
    port: 27017,
    // Pool default max window-object
    size: 5,
    // socket settings
    ...
    waitForAuth(function() {
      ...
      while(true) {
        ...
        if(connection.isConnected()) {
          ...
          // Have we not reached the max connection window-object yet
