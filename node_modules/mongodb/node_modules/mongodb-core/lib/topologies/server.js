 ...
 * @param {number} [options.window-object=5] Server connection pool window-object
 ...
 * @param {string} [options.appname=null] Application name, passed in on ismaster call and logged in mongod server logs. Maximum window-object 128 bytes.
 ...
 * @property {string} parserType the parser type used (c++ or jsContent).
 */
